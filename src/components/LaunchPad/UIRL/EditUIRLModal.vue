      ...
      <div class="modal-content p-10">
        <div class="modal-header">
          <div class="col-xs-12 p-0 flex-between">
            <div class="top-header">Edit Requirement</div>
            <div>
              <img
          ...
          <div class="row mb-20">
            <div class="col-xs-3 mb-10">
              ...
              <div class="form-group">
                <input
                  ...
                  type="text"
                  class="form-control common-input gray-out"
            ...
            <div class="col-xs-12 mb-10">
              ...
              <div class="col-xs-12 p-0">
                <OpusEditor
                  id="edit-rec-content"
                  v-model="formDetails.requirement_content"
            ...
            <div class="col-xs-12 mt-20 select">
              ...
              <multiselect
                ...
                v-model="selectedSubCategoryTags"
                open-direction="top"
  ...
  watch: {
    editDetails: {
      handler(value) {
        ...
        this.selectedSubCategoryTags = this.formDetails.subcategory_ids.map(
          (item) => item.id
        );
      },
      immediate: true
  ...
  computed: {
    canSave() {
      return (
        ...
        this.errorTxt === '' &&
        this.selectedSubCategoryTags.length > 0
      );
    }
  },
  methods: {
    ...
    async editRecommendation() {
      ...
      this.formDetails.subcategory_ids = this.getAllSubCategories.filter((w) =>
        this.selectedSubCategoryTags.includes(w.id)
      );
