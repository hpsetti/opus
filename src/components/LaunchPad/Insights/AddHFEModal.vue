<template>
  <div id="add-hfe" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content p-10">
        <div class="modal-header">
          <div class="col-xs-12 p-0 flex-between">
            <div class="top-header">Add HFE Insight</div>
            <div>
              <img
        ...
        <div class="modal-body">
            ...
            <div class="col-xs-12 mb-10">
              ...
              <div class="form-group">
                <input
                  ...
                  class="form-control common-input"
                  maxlength="256"
                  placeholder="Enter Author’s full name (Optional)"
                />
              </div>
            </div>
            <div class="col-xs-12 mb-10">
              ...
              <div class="form-group">
                <input
                  ...
                  class="form-control common-input"
                  maxlength="256"
                  placeholder="Enter Author’s work title (Optional)"
                />
              </div>
            </div>
          ...
          <div class="d-flex justify-content-end col-gap-20">
            <BaseButton variant="secondary" @click="closeAddNewContentPopUp"
              >Cancel</BaseButton
            >
            <BaseButton @click="addHfe" :disabled="!canSave">Save</BaseButton>
          </div>
        </div>
      </div>
    </div>
...
import { addHfe } from '../../../apis/hfeInsightsAdmin';
...
export default {
  ...
  methods: {
    ...
    async addHfe() {
      ...
      const response = await addHfe(this.formDetails);
      if (response) {
