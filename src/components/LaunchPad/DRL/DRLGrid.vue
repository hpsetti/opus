  ...
  <div class="col-md-12 col-lg-12 col-sm-12 pl-20 pr-20 xs-pr-0 mt-20">
    ...
    <div class="pagination-wrapper pt-20" v-if="filteredList.length > 0">
      <table class="projects-table">
        <thead>
          <tr>
            <th class="pl-15" @click="setSortBy('recommendation_title')">
              Title
              <span
                class="sort-key"
                :class="getSortKey('recommendation_title')"
              ></span>
            </th>
        ...
        <tbody>
          <tr v-for="rec in filteredList" :key="rec.id">
            <td class="pl-15">{{ rec.recommendation_title }}</td>
    ...
    <div v-if="filteredList.length === 0" class="norecords_wrapper">
      <div class="mt-50 no-records-found">No recommendations found!</div>
    </div>
    <EditDRLModal :editDetails="editDetails"></EditDRLModal>
    <DeleteDRLModal
      :rec="selectedItem"
...
import EditDRLModal from './EditDRLModal.vue';
import DeleteDRLModal from './DeleteDRLModal.vue';
...
export default {
  ...
  async created() {
    ...
    await this.getRecommendationsData();
    this.setSortBy('recommendation_title');
  },
  data() {
    return {
      recommendations: [],
