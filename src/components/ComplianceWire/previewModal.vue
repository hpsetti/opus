/** * @author Hemanth Alluddla * @email 85761@global.ul.com * @Preview Video modal */
<template>
  <div>
      ...
      <div class="modal-dialog modal-lg request-modal">
        ...
        <div class="modal-content col-xs-12 p-20" v-if="displayData">
          ...
          <div class="modal-body col-xs-12 text-start">
            <div class="col-xs-12 p-0">
              <div class="col-xs-12 p-0 training-title mb-5">Preview of {{ displayData.title }}</div>
              <div class="video-carosal mt-10">
                <video id="lms-preview-video" class="video-js video-content opus-intro-video" disablepictureinpicture controls controlslist="nodownload" @play="videoPlayed">
