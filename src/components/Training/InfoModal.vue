        ...
        <div class="modal-content col-xs-12 p-20" v-if="displayData">
              ...
              <div class="col-xs-12 pr-0 purchase-info-main mt-10">
                <div class="d-flex justify-content-between">
                  <div class="d-flex">
                    ...
                    <div
                      class="pl-15 pb-15"
                      v-if="displayData.previous_purchase_date"
                    >
          ...
          >
            ...
            <template v-else-if="displayData.enrolled">
              <BaseButton
                v-if="displayData.training_type === 'Course'"
                has-icon
            ...
            <div v-else>
              <BaseButton
                class="br-20"
                :has-icon="
                  displayData.cart_status.purchase_status === 'REMOVE_FROM_CART'
                "
                :class="{
                  'gray-out':
                    displayData && displayData.disable_as_bundle_added_to_cart,
                  primary:
                    displayData.cart_status.purchase_status === 'ADD_TO_CART',
                  secondary:
                    displayData.cart_status.purchase_status ===
                    'REMOVE_FROM_CART',
                  tertiary:
                    displayData.cart_status.purchase_status === 'GO_TO_CART'
                }"
                @click="
                  addRemoveCart(displayData.cart_status, displayData.plan_id)
                "
              >
                <img
