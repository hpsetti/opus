<template>
  <div id="training-signup-modal" class="modal" role="dialog">
      ...
      <div class="modal-content col-xs-12 p-20">
        ...
        <div class="modal-body">
          ...
          <div class="col-xs-9 text-regular-small text-secondary mb-20">
            Select a course time from the available list below. Once you select
            your course time and click on Add to account, you will be redirected
            to the marketplace to complete your purchase.
          </div>
          <div
            class="row col-xs-12"
          ...
          >
            <div
              ...
              :class="{ 'selected-slot': selectedSlotId === timeSlot.slot_id }"
            >
              <label class="radio">
                <input
                  type="radio"
