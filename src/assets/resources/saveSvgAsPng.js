(function() {
  ...
  function styles(el, selectorRemap) {
    ...
    for (var i = 0; i < sheets.length; i += 1) {
      try {
    	  if(sheets[i].href && sheets[i].href.indexOf('graph.css') != -1){
  ...
  out$.saveAsSVGWithStyle = function (el, options, cb) {
      ...
      inlineImages(el, function() {
          ...
          /*var chartTitle = document.createElement("text");
          ...
          chartTitle.setAttribute("text", "Upcoming expirations");
          //outer.appendChild(chartTitle);*/
          outer.appendChild(clone);
